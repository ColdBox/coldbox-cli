component excludeFromHelp=true extends="coldbox-cli.models.BaseCommand" {
	...
	function run(){
		...
		print
			...
			.greenLine( "  coldbox ai skills create <name>      Create a custom skill" )		.greenLine( "  coldbox ai skills remove <name>      Remove a skill (requires --core|--module|--custom)" )			.greenLine( "  coldbox ai skills refresh            Sync skills with installed modules" )
			.line()
			.yellowLine( "Examples:" )
			.line()
			.dim( "  ## List all skills" )
